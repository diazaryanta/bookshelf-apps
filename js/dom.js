...
function createActionDelete(idBook) {
  ...
  actionDelete.addEventListener("click", function () {
    let confirmation = confirm("buku akan dihapus, tekan ok");
...
function createActionRead(idBook) {
  ...
  action.addEventListener("click", function () {
    let confirmation = confirm("Telah selesai membaca buku, tekan ok");
...
function createActionUndo(idBook) {
  ...
  action.addEventListener("click", function () {
    let confirmation = confirm("belum selesai membaca buku ini, tekan ok");
    if (confirmation) {
      const cardParent = document.getElementById(idBook);
